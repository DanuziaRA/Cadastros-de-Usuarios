...
alert("Enviando os dados:" + username + " -" + password + "-" + userusuario + "-" + usercpf + "-" + userdisc + "-" + userpais + "-" + usernaluno + "-" + usercep + "-" + userbairro + "-" + "-" + userendereco + "-" + useremail + "-" + usercontato + "-" + userinativar + "-" + userreativar);
};
