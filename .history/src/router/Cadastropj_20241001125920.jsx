...
alert("Enviando os dados:" + username + " -" + password + "-" + userusuario + "-" + usercnpj + "-" + userproftutor + "-" + userpais + "-" + usernaluno + "-" + usercep + "-" + userbairro + "-" + "-" + userendereco + "-" + useremail + "-" + usercontato + "-" + userinativar + "-" + userreativar);
};
