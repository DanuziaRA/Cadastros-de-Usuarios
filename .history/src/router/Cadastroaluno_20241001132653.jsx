...
const Cadastro = () => {
  ...
  const [usercurso, setCurso] = useState("");
...
alert("Enviando os dados:" + username + " -" + password + "-" + userusuario + "-" + usercpf + "-" + usercurso + "-" +  usermatricula + "-" + usercep + "-" + userbairro + "-" + "-" + userendereco + "-" + useremail + "-" + usercontato + "-" + userinativar + "-" + userreativar);
};
  
  return (
    <div className='container'>
        <form onSubmit={handleSubmit}>
          <h2>Cadastro usuário: Aluno</h2>
            ...
            <div>
            <label>Curso</label>
            <input type="text" placeholder='curso completo'
