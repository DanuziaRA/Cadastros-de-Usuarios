...
const Cadastro = () => {
  ...
  const [usermatricula, set] = useState("");
...
alert("Enviando os dados:" + username + " -" + password + "-" + userusuario + "-" + usercpf + "-" + usercurso + "-" + usercep + "-" + userbairro + "-" + "-" + userendereco + "-" + useremail + "-" + usercontato + "-" + userinativar + "-" + userreativar);
};
