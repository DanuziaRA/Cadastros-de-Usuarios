...
const Cadastro = () => {
  ...
  const [usermatserv, setMatserv] = useState("");const [useremail, setEmail] = useState("");
...
alert("Enviando os dados:" + username + " -" + password + "-" + userusuario + "-" + usercnpj + "-" + usernome + "-" + usermatserv + "-" + usernaluno + "-" + usercep + "-" + userbairro + "-" + "-" + userendereco + "-" + useremail + "-" + usercontato + "-" + userinativar + "-" + userreativar);
};
