...
const Cadastro = () => {
  ...
  const [usernomefantasia, setMatserv] = useState("");
...
alert("Enviando os dados:" + username + " -" + password + "-" + userusuario + "-" + usercnpj + "-" + usermatserv + "-" + userpais + "-" + usernaluno + "-" + usercep + "-" + userbairro + "-" + "-" + userendereco + "-" + useremail + "-" + usercontato + "-" + userinativar + "-" + userreativar);
};
