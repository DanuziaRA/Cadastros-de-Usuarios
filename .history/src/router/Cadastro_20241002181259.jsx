...
const Cadastro = () => {
  ...
  fetch("http://localhost:5000/cadastros",{
    ...
    .then((resp) => resp.json())
    .then((data) => {
      setUsername,setCpf,setPassword,setProftutor,setNaluno,setPais,setCep,setBairro,setEndereco,setContato,setEmail,setInativar,setReativar(data)
    })
    .catch((err) => console.log(err))
  
const handleSubmit = (event) => {
  event.preventDefault();
alert("Enviando os dados:" + username + " -" + password + "-" + userusuario + "-" + usercpf + "-" + userproftutor + "-" + userpais + "-" + usernaluno + "-" + usercep + "-" + userbairro + "-" + "-" + userendereco + "-" + useremail + "-" + usercontato + "-" + userinativar + "-" + userreativar);
};
